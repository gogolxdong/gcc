...
namespace __gnu_pbds
{
  ...
  namespace detail
  {
    ...
    template <
        ...
        typename Allocator>
    struct
        basic_tree_policy_base<Const_Node_Iterator, Const_Node_Iterator, Allocator>
    {
    };
  } // namespace detail
  template <typename, typename, typename, typename>
  struct null_tree_node_update;
  template <typename Const_Node_Iterator, typename Node_Iterator, typename, typename Allocator>
  class tree_order_statistics_node_update : detail::basic_tree_policy_base<Const_Node_Iterator, Node_Iterator, Allocator>
  {
  public:
    ...
    typedef
        typename allocator_type::template rebind<metadata_type>::other::reference metadata_reference;
  ...
  tree_order_statistics_node_update<
      ...
      Node_Iterator,
      Cmp_Fn,
      Allocator>::operator()(node_iterator node_it, const_node_iterator end_nd_it) const
  {
    ...
    const_cast<metadata_reference>(node_it.get_metadata()) = l_rank + r_rank;
  }
  namespace
  {
    ...
    struct value_type_base<Key, null_mapped_type, Allocator, false>
    {
      ...
      typedef
          typename Allocator::template rebind<value_type>::other value_type_allocator;
    ...
    template <
        typename Key,
        typename Mapped, typename Alloc, bool Store_Extra>
    ...
    protected:
      typedef
          typename Allocator::template rebind<typename Node_And_It_Traits::node>::other::pointer node_pointer;
      typedef
          typename types_traits<Key, Mapped, Allocator, false>::const_reference const_reference;
  ...
  namespace detail
  {
    template <typename Key, typename Mapped, typename Cmp_Fn, typename Node_And_It_Traits, typename Allocator>
    class rb_tree_no_data_ : bin_search_tree_no_data_<Key, Mapped, Cmp_Fn, Node_And_It_Traits, Allocator>
    {
      typedef bin_search_tree_no_data_<Key, Mapped, Cmp_Fn, Node_And_It_Traits, Allocator> base_type;
    ...
    template <
        ...
        typename Allocator>
    std::pair<
        typename rb_tree_no_data_<
            Key,
            Mapped,
            Cmp_Fn,
            Node_And_It_Traits,
            Allocator>::point_iterator,
        bool>
        rb_tree_no_data_<
            Key,
            Mapped,
    ...
    template <
        ...
        typename Alloc>
    struct
        container_base_dispatch<Key, null_mapped_type, rb_tree_tag, Policy_Tl, Alloc>
    {
    ...
    {
      typedef
          typename Allocator::template rebind<Node>::other::pointer node_pointer;

    public:
      typedef typename Node::metadata_type metadata_type;
      typedef
          typename Allocator::template rebind<metadata_type>::other::const_reference const_metadata_reference;
      bin_search_tree_const_node_it_(node_pointer p_nd) : m_p_nd((p_nd))
      {
      }
    ...
    template <
        ...
        Allocator>
    struct
        bin_search_tree_traits<Key, null_mapped_type, Cmp_Fn, Node_Update, Node, Allocator>
    {
      typedef types_traits<Key, null_mapped_type, Allocator, false> type_traits;
      typedef Node node;
      typedef bin_search_tree_const_it_<
          ...
          typename type_traits::const_reference, true, Allocator>
          const_point_iterator;
      typedef const_point_iterator point_iterator;
      typedef bin_search_tree_const_node_it_<
          Node,
          const_point_iterator, point_iterator, Allocator>
          const_node_iterator;
      typedef const_node_iterator node_iterator;
      typedef Node_Update<const_node_iterator, node_iterator, Cmp_Fn, Allocator> node_update;
    };
    template <typename Node_Update, bool>
    ...
    {
      typedef dumconst_node_iterator<Key, Data, Allocator> dumconst_node_it;
      enum
      {
      ...
      typedef
          typename tree_metadata_helper<
              Node_Update<
                  dumconst_node_it,
                  dumconst_node_it, Cmp_Fn, Allocator>,
              null_update>::type type;
    };
    template <
        typename,
        typename,
    ...
    struct rb_tree_node_
    {
      ...
      typedef
          typename Allocator::template rebind<
              rb_tree_node_<Value_Type, Metadata, Allocator>>::other::pointer node_pointer;
      typedef
          typename Allocator::template rebind<metadata_type>::other::reference metadata_reference;
    ...
    struct
        tree_traits<Key,
                    ...
                    Node_Update,
                    rb_tree_tag,
                    Allocator> : bin_search_tree_traits<Key,
                                                        Mapped,
                                                        Cmp_Fn,
                                                        Node_Update,
                                                        rb_tree_node_<
                                                            ...
                                                            typename tree_node_metadata_selector<
                                                                Key,
                                                                Mapped, Cmp_Fn, Node_Update, Allocator>::type,
                                                            Allocator>,
                                                        Allocator>
    {
    };
  } // namespace detail
  template <typename Key, typename Mapped, typename Tag, typename Policy_Tl, typename Allocator>
  class container_base : public detail::container_base_dispatch<Key, Mapped, Tag, Policy_Tl, Allocator>::type
  {
  };
  template <typename Key, typename Mapped, typename Tag, typename, typename Policy_Tl, typename Allocator>
  class basic_tree : public container_base<Key, Mapped, Tag, Policy_Tl, Allocator>
  {
  };
  template <
      typename Key,
  ...
  class
      tree : public basic_tree<
                 ...
                 typename __gnu_cxx::typelist::create2<
                     Cmp_Fn,
                     detail::tree_traits<Key, Mapped, Cmp_Fn, Node_Update, Tag, Allocator>>::type,
                 Allocator>
  {
  };
} // namespace __gnu_pbds
